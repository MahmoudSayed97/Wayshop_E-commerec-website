                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           <form class="col-sm-6" action="{{url('/admin/edit-product/'.$prodDetails->id)}}" method='post'>
                           @csrf 
                           <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="{{$prodDetails->name}}" name="product_name" id="product_name"required>
                              </div>
                              <div class="form-group">
                                 <label>Product code Name</label>
                                 <input type="text" class="form-control" placeholder="{{$prodDetails->code}}" name="product_code" id="product_code"required>
                              </div>
                              <div class="form-group">
                                 <label>Product color</label>
                                 <input type="text" class="form-control" placeholder="{{$prodDetails->color}}" name="product_color" id="product_color"required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="hidden" name="old_picture" value="{{$prodDetails->image}}">
                              </div>
