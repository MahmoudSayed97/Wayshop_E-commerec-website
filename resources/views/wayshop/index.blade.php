                    ...
                    <div class="filter-sidebar-left">
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            @foreach($categories as $category)
                                    @if($category->parient_id==0)

                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#{{$category->id}}" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$category->name}} <small class="text-muted">(100)</small>
                                </a>
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    @foreach($categories as $subcategory)
                                        @if($category->id == $subcategory->parient_id)
                                    <div class="list-group">
                                            <a href="{{url('/categories/'.$subcategory->id)}}" class="list-group-item list-group-item-action active">{{$subcategory->name}} <small class="text-muted">(50)</small></a>
                                    </div>
                                            @break
                                        @endif
                                    @endforeach
                                        ...
                                        <div class="products-single fix">
                                            <div class="box-img-hover">
                                                ...
                                                <div class="mask-icon">
                                                    ...
                                                    <a class="cart" href="/products/{{$product->id}}">Details Page</a>
                                                </div>
                                            </div>
                                            <div class="why-text">
